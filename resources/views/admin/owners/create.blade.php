                            ...
                            <div class="-m-2">
                             ...
                             {{-- <div class="p-2 w-full">
                              ...
                              <div class="p-2 w-full flex justify-center mt-4">
                                <button onclick="location.href='{{ route('admin.owners.index')}}'" class="mx-auto bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">戻る</button>
                                <button class="mx-auto bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">登録</button>
                              </div>
                              </div>
                              {{-- <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                <a class="text-green-500">ex4ample@email.com</a>
